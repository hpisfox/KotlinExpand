...
/**
 * 在 [ViewGroup] 中创建 [AppCompatImageView] 实例
 * @param style 在 xml 中定义的样式 int 值
 * @param autoAdd 是否自动将 [AppCompatImageView] 添加到 [ViewGroup]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ViewGroup] 中创建 [AppCompatButton] 实例
 * @param style 在 xml 中定义的 style int 值
 * @param autoAdd 是否自动将 [AppCompatButton] 添加到 [ViewGroup]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ViewGroup] 中创建 [View] 实例
 * @param style 在 xml 中定义的样式 int 值
 * @param autoAdd 是否自动将 [View] 添加到 [ViewGroup]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ViewGroup] 中创建 [RelativeLayout] 实例
 * @param style 在 xml 中定义的 style int 值
 * @param autoAdd 是否自动将 [RelativeLayout] 添加到 [ViewGroup]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
*在 [ViewGroup] 中创建 [LinearLayout] 实例
* @param style 在 xml 中定义的 style int 值
* @param autoAdd 是否自动将 [LinearLayoutCompat] 添加到 [ViewGroup]
* @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ViewGroup] 中创建 [NestedScrollView] 实例
 * @param style 在 xml 中定义的样式 int 值
 * @param autoAdd 是否自动将 [NestedScrollView] 添加到 [ViewGroup]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ViewGroup] 中创建 [RecyclerView] 实例
 * @param style 在 xml 中定义的 style int 值
 * @param autoAdd 是否自动将 [RecyclerView] 添加到 [ViewGroup]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ViewGroup] 中创建 [ConstraintLayout] 实例
 * @param style 在 xml 中定义的 style int 值
 * @param autoAdd 是否自动将 [ConstraintLayout] 添加到 [ViewGroup]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ViewGroup] 中创建 [FrameLayout] 实例
 * @param style 在 xml 中定义的 style int 值
 * @param autoAdd 是否自动将 [FrameLayout] 添加到 [ViewGroup]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ViewGroup] 中创建 [ViewFlipper] 实例
 * @param style 在 xml 中定义的 style int 值
 * @param autoAdd 是否自动将 [ViewFlipper] 添加到 [ViewGroup]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ViewGroup] 中创建 [AppCompatEditText] 实例
 * @param style 在 xml 中定义的 style int 值
 * @param autoAdd 是否自动将 [AppCompatEditText] 添加到 [ViewGroup]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ViewGroup] 中创建 [Horizo​​ntalScrollView] 实例
 * @param style 在 xml 中定义的 style int 值
 * @param autoAdd 是否自动将 [Horizo​​ntalScrollView] 添加到 [ViewGroup]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ViewGroup] 中创建 [ViewPager2] 实例
 * @param style 在 xml 中定义的 style int 值
 * @param autoAdd 是否自动将 [ViewPager2] 添加到 [ViewGroup]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ConstraintLayout] 中创建 [Guideline] 实例
 * @param style 在 xml 中定义的 style int 值
 * @param autoAdd 是否自动将 [Guideline] 添加到 [ConstraintLayout]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ConstraintLayout] 中创建 [Barrier] 实例
 * @param style 在 xml 中定义的 style int 值
 * @param autoAdd 是否自动将 [Barrier] 添加到 [ConstraintLayout]
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [Fragment] 中创建 [ConstraintLayout] 实例
 * @param style 在 xml 中定义的 style int 值
 * @param init 在此 lambda 中为此视图设置属性
 */
...
/**
 * 在 [ConstraintLayout] 中构建水平或垂直链
 * [startView] 是链的起点
 * [endView] 是链的终点
 * [views] 是链的主体
 * [orientation] 可以是 [horizo​​ntal] 或 [vertical] ]
 */
...
/**
 * 一个新的 View.OnClickListener 可以防止点击抖动
 */
...
fun EditText.setDebounceListener(timeoutMillis: Long, action: (CharSequence) -> Unit) {
    ...
    val textChangeActor = mainScope.actor<CharSequence>(capacity = Channel.UNLIMITED) {
        consumeAsFlow().debounce(timeoutMillis).collect { action(text) }
    }.autoDispose(this)
...
/**
 * 根据 [otherRect] 得到 [Rect] 的相对矩形，考虑 [otherRect] 的左边和顶部为零
 */
